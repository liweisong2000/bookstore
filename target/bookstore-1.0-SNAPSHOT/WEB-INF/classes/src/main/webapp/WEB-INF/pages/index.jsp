...
<body>
	...
	<div class="head"> 
			<img class="pic1" src="image/BookStore.png" />
			<img class="pic2" src="image/求知书屋.png"   />  
	
    		<form class="search" action="#" method="post">
      			<input class="s1"type="text" placeholder="书名/作者" >
      			<img class="searchp" src="image/search.png" alt=""/>
    		...
    		<c:otherwise>
    			<button class="log">
      				<a style="color:white;" href="${pageContext.request.contextPath}/register.jsp">注册</a>/
      				<a style="color:white;" href="${pageContext.request.contextPath}/login.jsp">登录</a>
    			</button>
    		</c:otherwise>
    		</c:choose>
	</div>
	...
	<div class="center">
		...
		<c:when test="${power ==null}">
			<button class="b1" onclick="window.location='index.jsp'">首页</button>
		</c:when>
		<c:when test="${power eq 1}">
			<button class="b1" onclick="window.location='index.jsp'">首页</button>
			<button class="b2" onclick="window.location='FindAllBookServlet?way=BookManage'">图书管理</button>
			<button class="b3" onclick="window.location='FindPersonServlet'">个人资料</button>
			<button class="b4" onclick="window.location='ShopRecordServlet'">购物车</button>
			<button class="b5" onclick="window.location='CancelUserServlet'">注销</button>
			<button class="b6" onclick="window.location='register.jsp'">注册</button>
		</c:when>
		<c:otherwise>
			<button class="b1" onclick="window.location='index.jsp'">首页</button>
			...
			<button class="b5" onclick="window.location='register.jsp'">注册</button>
		</c:otherwise>
		</c:choose>
	<div class="con">
   		<i class="arrow-l"><img src="image/arrow1.png" style="width:50px; height:50px; position:relative;right:9px;top:15px;"/></i>
   		<i class="arrow-r"><img src="image/arrow2.png" style="width:50px; height:50px; position:relative;right:2px;top:15px;"/></i>
   	<ul class="d">
   		<li>
			<a href="js/index.js"><img src="image/book1.jpeg" alt="" style="width: 1300px;height: 570px;"/></a>
		</li>
		<li class="da">
		<a href="js/index.js"><img src="image/book2.jpeg" alt="" style="width: 1300px;height: 570px;"/></a>
		</li>
		<li class="da">
		<a href="js/index.js"><img src="image/book3.jpeg" alt="" style="width: 1300px;height: 570px;"/></a>
		</li>
		<ol class="db">
     	<li class="d1"></li>
     	<li class="d2"></li>
...
<a onclick="window.open('BookDetailServlet?bookname=湘行散记', 'newwindow', 'height=320,width=530,top=240,left=500,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no');">
			<img src="image/湘行散记.jpg" alt="" style="width: 198px;height: 298px;"/>
...
<a onclick="window.open('BookDetailServlet?bookname=爱是一场渐行渐远的分离', 'newwindow', 'height=320,width=530,top=240,left=500,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no');">
			<img src="image/爱是一场渐行渐远的分离.jpg" alt="" style="width: 198px;height: 298px;"/>
...
<a onclick="window.open('BookDetailServlet?bookname=三体', 'newwindow', 'height=320,width=530,top=240,left=500,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no');">
			<img src="image/三体.jpg" alt="" style="width: 198px;height: 298px;"/>
...
<a onclick="window.open('BookDetailServlet?bookname=狂人日记', 'newwindow', 'height=320,width=530,top=240,left=500,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no');">
			<img src="image/狂人日记.jpg" alt="" style="width: 198px;height: 298px;"/>
...
<a onclick="window.open('BookDetailServlet?bookname=呐喊', 'newwindow', 'height=320,width=530,top=240,left=500,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no');">
			<img src="image/呐喊.jpg" alt="" style="width: 198px;height: 298px;"/>
...
<a onclick="window.open('BookDetailServlet?bookname=解忧杂货店', 'newwindow', 'height=320,width=530,top=240,left=500,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no');">
			<img src="image/解忧杂货店.jpg" alt="" style="width: 198px;height: 298px;"/>
	...
	<img src="image/Hacking.jpg" alt="" style="width:282px;height:427px;margin-top:30px;margin-left:90px;"/>
	</a>
		<ul class="RecomMes">
			...
			<li><img style="margin-left:43px;margin-top:15px;"src="image/star1.png"/>
			<img src="image/star1.png"/>
			<img src="image/star1.png"/>
			<img src="image/star1.png"/>
